...
namespace hoa
{
    ...
    public:
        ...
        Recomposer(ulong order, ulong numberOfPlanewaves)  :
    ...
    template <typename T> class Recomposer<Hoa2d, T, Fisheye> : public Harmonic<Hoa2d, T>::Processor, public Planewave<Hoa2d, T>::Processor
    {
    private:
    ...
    public:
        ...
        inline void setFisheye(const T fisheye) 
        {
        ...
        inline void process(const T* inputs, T* outputs) const 
        {
    ...
    template <typename T> class Recomposer<Hoa2d, T, Free> : public Harmonic<Hoa2d, T>::Processor, public Planewave<Hoa2d, T>::Processor
    {
    private:
    ...
    public:
        ...
        inline void setWidening(const ulong index, const T radius) 
        {
        ...
        inline T getWidening(const ulong index) const 
        {
