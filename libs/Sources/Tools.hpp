...
namespace hoa
{
    ...
    public:
        ...
        inline ulong getRamp() const 
        {
            return m_ramp;
        }
        
        inline T getValue(const ulong index) const 
        {
            return m_value_new;
        }
        
        inline void setRamp(const ulong ramp) 
        {
        ...
        inline void setRadiusDirect(const T value) 
        {
    ...
    public:
        ...
        PolarLines(ulong numberOfSources)  :
        ...
        inline void setRadiusDirect(const ulong index, const T radius) 
        {
        ...
        inline void setAzimuthDirect(ulong index, const T azimuth) 
        {
    ...
    public:
        ...
        inline void setElevation(const ulong index, const T elevation) 
        {
        ...
        inline void setAzimuthDirect(const ulong index, const T azimuth) 
        {
            m_values_old[index + m_number_of_sources] = m_values_new[index + m_number_of_sources] = azimuth;
            m_values_step[index + m_number_of_sources] = 0.;
            m_counter = 0;
        ...
        inline void setElevationDirect(const ulong index, const T elevation) 
        {
