...
{    
    ...
    public:
        ...
        inline ulong getDegree() const 
        {
            return m_degree;
        }
        
        inline long getOrder() const 
        {
            return m_order;
        }
        ...
        public:
            ...
            /** Retrieve the decomposition order.
             @return The order.
             */
            inline ulong getDecompositionOrder() const 
            {
             ...
             */
            inline ulong getNumberOfHarmonics() const 
            {
            ...
            /** The orders of the harmonic are in the range -order to order.
             ...
             @see       getHarmonicName()
             */
            inline long getHarmonicOrder(const ulong index) const 
            {
            ...
            /** The degrees of the harmonics are in the range 0 to decomposition order.
             ...
             @see       getHarmonicName()
             */
            inline ulong getHarmonicDegree(const ulong index) const 
            {
            ...
            /** The indices of the harmonics are in the range 0 to number of harmonics - 1.
             ...
             @see       getHarmonicName()
             */
            inline ulong getHarmonicIndex(const ulong degree, long order) const 
            {
