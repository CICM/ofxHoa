...
namespace hoa
{
    ...
    public:
        ...
        Planewave(const ulong _index, const T _azimuth)  :
        m_index(_index),
        m_azimuth(_azimuth)
        {
        ...
        inline T getAbscissa(const T x_axe = 0.) const 
        {
            return cos(m_azimuth + x_axe + HOA_PI2);
        }
        
        inline T getOrdinate(const T x_axe = 0.) const 
        {
        ...
        bool operator<(Planewave const& j) const 
        {
        ...
        public:
             ...
             */
            Processor(const ulong numberOfPlanewaves)  :
            ...
            /** Retrieve the decomposition order.
             @return The order.
             */
            inline ulong getNumberOfPlanewaves() const 
            {
             ...
             */
            inline void setPlanewavesRotation(const T z_axe) 
            {
             ...
             */
            inline T getPlanewavesRotation() const 
            {
                return m_rotation_z;
            }
             ...
             */
            inline ulong getPlanewaveIndex(const ulong index) 
            {
             ...
             */
            inline void setPlanewaveAzimuth(const ulong index, const T azimuth) 
            {
            ...
            /** Retrieve the azimuth of a planewaves. The azimuth of the planewaves is in radian, 0 radian is at the front of the soundfield and π is at the back of the sound field. The maximum index must be the number of planewaves - 1.
             ...
             @return     The azimuth of the planewaves.
             */
            inline T getPlanewaveAzimuth(const ulong index) const 
            {
            ...
            /** Retrieve the azimuth of a planewaves. The azimuth of the planewaves is in radian, 0 radian is at the front of the soundfield and π is at the back of the sound field. The maximum index must be the number of planewaves - 1.
             ...
             @return     The azimuth of the planewaves.
             */
            inline T getPlanewaveAzimuthRotated(const ulong index) const 
            {
             ...
             */
            inline T getPlanewaveAbscissa(const ulong index) const 
            {
             ...
             */
            inline T getPlanewaveOrdinate(const ulong index) const 
            {
             ...
             */
            inline std::string getPlanewaveName(const ulong index) const 
            {
    ...
    public:
        ...
        Planewave(const ulong _index, const T _azimuth, const T _elevation)  :
        m_index(_index),
        m_azimuth(_azimuth),
        ...
        inline void setElevation(const T elevation) 
        {
            m_elevation = elevation;
        }
        
        inline T getAbscissa(const T x_axe = 0., const T y_axe = 0., const T z_axe = 0.) const 
        {
        ...
        inline T getOrdinate(const T x_axe = 0., const T y_axe = 0., const T z_axe = 0.) const 
        {
            T x = cos(m_azimuth + HOA_PI2) * cos(m_elevation);
            T y = sin(m_azimuth + HOA_PI2) * cos(m_elevation);
            T z = sin(m_elevation);
        ...
        inline T getHeight(const T x_axe = 0., const T y_axe = 0., const T z_axe = 0.) const 
        {
            T x = cos(m_azimuth + HOA_PI2) * cos(m_elevation);
            T y = sin(m_azimuth + HOA_PI2) * cos(m_elevation);
            T z = sin(m_elevation);
        ...
        public:
            ...
            /**	Set the azimuth offset of the planewaves in radian.
             @param     offset		An azimuth value.
             */
            inline void setPlanewavesRotation(const T x_axe, const T y_axe, const T z_axe) 
            {
            ...
            /**	Retreive the azimuth offset of the planewaves in radian.
             @return    The offset of the planewaves.
             */
            inline T getPlanewavesRotationX() const 
            {
                return m_rotation_x;
            }
            ...
            /**	Retreive the azimuth offset of the planewaves in radian.
             @return    The offset of the planewaves.
             */
            inline T getPlanewavesRotationY() const 
            {
                return m_rotation_y;
            }
            ...
            /**	Retreive the azimuth offset of the planewaves in radian.
             @return    The offset of the planewaves.
             */
            inline T getPlanewavesRotationZ() const 
            {
                return m_rotation_z;
            }
            ...
            /** Retrieve the azimuth of a planewaves. The azimuth of the planewaves is in radian, 0 radian is at the front of the soundfield and π is at the back of the sound field. The maximum index must be the number of planewaves - 1.
             ...
             @return     The azimuth of the planewaves.
             */
            inline void setPlanewaveElevation(const ulong index, const T azimuth) 
            {
            ...
            /** Retrieve the azimuth of a planewaves. The azimuth of the planewaves is in radian, 0 radian is at the front of the soundfield and π is at the back of the sound field. The maximum index must be the number of planewaves - 1.
             ...
             @return     The azimuth of the planewaves.
             */
            inline T getPlanewaveElevation(const ulong index) const 
            {
            ...
            /** Retrieve the azimuth of a planewaves. The azimuth of the planewaves is in radian, 0 radian is at the front of the soundfield and π is at the back of the sound field. The maximum index must be the number of planewaves - 1.
             ...
             @return     The azimuth of the planewaves.
             */
            inline T getPlanewaveElevationRotated(const ulong index) const 
            {
             ...
             */
            inline T getPlanewaveHeight(const ulong index) const 
            {
